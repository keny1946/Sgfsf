    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-4 text-center">
                <form class="text-center" id="cuadro1">
                    ...
                    <button type="submit" class="btn btn-outline-dark btn-block">Aceptar</button>
                    <br>
                    <a href="/registrar"><h6 class="text-dark">Registrarse</h6></a>
                    <br>
                </form>
            </div>
            <div class="col-4"></div>
