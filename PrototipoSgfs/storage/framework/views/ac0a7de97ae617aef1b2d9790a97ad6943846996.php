...
unset($__errorArgs, $__bag); ?>" name="nombre" value="<?php echo e(old('nombre')); ?>" autocomplete="name" autofocus onkeypress="return soloLetras(event)">
...
unset($__errorArgs, $__bag); ?>" name="apellido" value="<?php echo e(old('apellido')); ?>" autocomplete="apellido" autofocus onkeypress="return soloLetras(event)">
...
unset($__errorArgs, $__bag); ?>" name="telefono" value="<?php echo e(old('telefono')); ?>"  autocomplete="telefono" autofocus >
...
unset($__errorArgs, $__bag); ?>" name="Domicilio" value="<?php echo e(old('Domicilio')); ?>"  autocomplete="telefono" autofocus>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Correo Eletrónico')); ?></label>
...
<?php /**PATH C:\xampp\htdocs\PrototipoSgfs\resources\views/auth/register.blade.php ENDPATH**/ ?>