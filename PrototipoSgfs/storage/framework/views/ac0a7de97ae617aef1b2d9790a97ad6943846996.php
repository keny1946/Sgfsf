        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="cuadro1" method="POST" action="<?php echo e(route('register')); ?>">
                            <?php echo csrf_field(); ?>
                            <br>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Correo Eletronico')); ?></label>
...
</html><?php /**PATH C:\xampp\htdocs\PrototipoSgfs\resources\views/auth/register.blade.php ENDPATH**/ ?>