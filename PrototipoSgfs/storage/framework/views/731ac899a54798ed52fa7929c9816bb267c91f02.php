                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form method="POST" action="/empleado/<?php echo e(['id'=>$empleados->id]); ?> " enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.Admin.appD', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\XAMMPP\htdocs\PrototipoSgfs\resources\views/admin/EditarEmpleado.blade.php ENDPATH**/ ?>